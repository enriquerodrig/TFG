...
class CrossLinked:
    def __init__(self, search_engine, target, timeout, conn_timeout=3, proxies=[], jitter=0, n_targets=None):
        self.results = []
        self.url = {'google': 'https://www.google.com/search?q=site:linkedin.com/in+"{}"&num=100&start={}',
                    ...
                    # 'yahoo': 'https://search.yahoo.com/search?p="{}"+site:linkedin.com/in&b={}',
                    # 'duckduckgo': 'https://duckduckgo.com/html/?q="{}"+site:linkedin.com/in&kl=us-en&s={}',
                    }
    ...
    def search(self):
        ...
        while search_timer.running:
            try:
                ...
                if self.n_targets and len(self.results) >= self.n_targets:
                    Log.info("Target limit reached, exiting search for {}...".format(self.search_engine))
                    break
        ...
        if self.n_targets and len(self.results) >= self.n_targets:
            Log.info("Target limit reached, exiting search...")
